...
class PhotoRoof extends React.Component {
  constructor(props) {
    super(props);
  }
  renderItem = ({item}) => {
    const language = this.props.lang;
    const imge = item.book_cover.replace('../..', 'https://www.ekiaai.com');
    ...
    return (
      <TouchableOpacity
        ...
        style={{
          marginHorizontal: -55 * theme.consts.BW,
        }}>
        <View
          style={{
            alignItems: 'center',
          ...
          <View
            ...
            <View
              ...
              <View style={{width: 202 * theme.consts.BW}}>
                <Image
                  source={{uri: imge}}
                  style={{
